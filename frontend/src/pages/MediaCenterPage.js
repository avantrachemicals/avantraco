...
export default function MediaCenterPage() {
  ...
  return (
    <div data-testid="media-center-page" className="min-h-screen bg-gray-50">
      {/* Hero */}
      <section className="py-16 md:py-24 bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Badge className="bg-[#D9F99D] text-[#044736] mb-4">News & Updates</Badge>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4">Media Center</h1>
